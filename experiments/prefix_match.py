"""
Prefix match proposed by Automatically Identifying Known Software Problems
"""
...
def run(args, report_db, validationDataset):
    ...
    scorer = Scorer(report_db, SimilarityMethod.PREFIX_MATCH, args.aggregate, arguments, args.max_depth,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-aggregate', default="max", help="Options: max, avg_query, avg_cand, avg_short, avg_long w_avg_query, w_avg_short, w_max_query")
    parser.add_argument('-reuse', type=int, default=0, help="")
